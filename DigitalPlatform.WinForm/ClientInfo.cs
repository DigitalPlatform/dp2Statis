...
#region 使用计数
    ...
    TaskScheduler.Default);
        ...
        // Click Once 部分功能可能要到 .NET 7 才会有
        // https://github.com/dotnet/core/issues/5954
        // https://github.com/dotnet/deployment-tools/issues/27
        // https://github.com/dotnet/deployment-tools/issues/53
    ...
    "dp2circulation_v2\\dp2circulation.xml");
        ...
        public static void MemoryState(Form form, string section, string entry)
        {
            form.Load += (s1, e1) =>
            {
                ...
                {
                    FormProperty.SetProperty(state, form, /*ClientInfo.IsMinimizeMode()*/ false);
                }
            };
