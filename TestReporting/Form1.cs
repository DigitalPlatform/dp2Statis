...
bool bClickClose = false)
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            */
            ...
            this._channelPool.BeforeLogin += new BeforeLoginEventHandle(Channel_BeforeLogin);
        ...
        internal void Channel_BeforeLogin(object sender, BeforeLoginEventArgs e)
        {
            if (e.FirstTry == true)
            {
...
dlg.UiState);
    ...
    out strError);
        ...
        {
            using (PgsqlDataSourceDlg dlg = new PgsqlDataSourceDlg())
            {
